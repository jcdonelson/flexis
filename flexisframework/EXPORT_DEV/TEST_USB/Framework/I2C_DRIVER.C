...
{
  if((IIC1S_BUSY)||(I2C_Status & CHAN_BUSY)||(ReadBufferSize) || (WriteBufferSize) ) 
  { 
            return ERROR_BUSBUSY;                 
  }
  return 0;
...
byte I2CInit(void)
{
  ...
  I2C_Status = 0; 
  DeviceAddress = 0x10; 
  IIC1F = 0x49;   // mul = 2   0x89 = 172KHz 0x8A=160K  0x80=285K 0x8E = 100K
